<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteMenu.aspx.cs" Inherits="Project_Nusantara_Resto.DeleteMenu" %>
                        ...
                        <div class="card-body">
                            ...
                            <form id="formDelete" runat="server" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <asp:TextBox runat="server" ID="txtMenuStock" CssClass="form-control" required="required" ReadOnly="true"></asp:TextBox>
                                </div>

                                <div class="mb-3">
                                    <label for="txtMenuImage" class="form-label">menuImage</label><br />
                                    <asp:Image CssClass="resized-image" ID="imgMenu" runat="server" />
                                </div>
                                <div class="mb-3">
                                    <label for="txtMenuPrice" class="form-label">menuPrice</label>
                                    <asp:TextBox runat="server" ID="txtMenuPrice" CssClass="form-control" required="required" ReadOnly="true"></asp:TextBox>
                                </div>
                                <div class="mb-3">
                                ...
                                <div style="text-align: center;">
                                    ...
                                    <a href="menu.aspx" class="btn btn-warning">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
